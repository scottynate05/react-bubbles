...
- [x] Explain what a token is used for.
  ...
  A token is a key used to validate a user's authorization. Each user will have their own token.

- [x] What steps can you take in your web apps to keep your data secure?

  Encryption to keep data secure until the appropriate key can be used to access that data.

- [x] Describe how web servers work.

  Web servers hold code for websites, and users can access those websites by locating a specific server through a URL and domain name.
